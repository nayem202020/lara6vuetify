...
export default {
    ...
    watch: {
        ...
        pagination:{
            handler(){
                ...
                getDataFromBacked().then(data=>{
                    console.log('update paginate',data)
                })
            },
            deep:true
        }
    ...
    created() {
         this.perPage = +(localStorage.getItem('itemPerPage')||5);
    ...
    methods: {
        ...
        paginate(e) {
            ...
            axios.get(`/api/roles?page=${e.page}`, {params: {'per_page': e.itemsPerPage}})
               ...
               localStorage.setItem('itemPerPage',e.itemsPerPage);
